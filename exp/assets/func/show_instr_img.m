function [btn,onset] = show_instr_img(instr_images,window,dio,lpt_adr)
% [btn,onset] = show_instr_img(instr_images,window,dio,lpt_adr) displays 
...
for i = 1:length(instr_images)
    ...
    [btn.n(i),btn.t(i),btn.port(i,:)] = parallel_button(inf,onset{i,1},'variable',dio,lpt_adr);    
end
