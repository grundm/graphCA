function plot_PM_run(PM)
%   plot_PM_run(PM) creates a figure of the applied intensities and threshold
%   estimations over the run of the psi method block.
%
...
Fig_PM = figure;
set(Fig_PM,'Name','Psi method estimation over trials');
